...
const Whoami = () => {
  ...
  const paddingMobile = isMobile ? '0rem' : '12rem';

  return (
    <div className="whoami">
      <div style={{ backgroundColor: colors.background, color: colors.text, paddingLeft: paddingMobile, paddingRight: paddingMobile }} className="text-box">
